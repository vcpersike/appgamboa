...
COPY ["AppGamboaSite.Web/AppGamboaSite.Web.csproj", "AppGamboaSite.Web/"]
COPY ["AppGamboaSite.Shared/AppGamboaSite.Shared.csproj", "AppGamboaSite.Shared/"]

# Restaura as dependências
RUN dotnet restore "AppGamboaSite.Web/AppGamboaSite.Web.csproj" \
...
RUN dotnet publish "AppGamboaSite.Web/AppGamboaSite.Web.csproj" \
